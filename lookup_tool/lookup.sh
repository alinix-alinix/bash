...
# Заголовок таблицы
echo "fqdn;crontab;ip_addresses;cpu_cores;ram_size_GB;disk_count;disk_sizes_gb" > "$OUTPUT_FILE"
...
get_host_info() {
    ...
    # Получаем информацию о физических дисках типа sda, sdb и т.д.
    ...
    echo "$fqdn;$crontab_content;$ip_addresses;$cpu_cores;$ram_size_gb;$disk_count;$disk_sizes_gb" >> "$OUTPUT_FILE"
}
